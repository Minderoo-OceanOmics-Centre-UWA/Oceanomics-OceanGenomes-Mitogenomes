...
workflow MITOGENOME_ANNOTATION {
    ...
    // (MITOS2) + FIX corals (fixer). co1/12S/16S come straight from EMMA for every
    ...
    ch_annot_results = ch_emma_results_trna.mix(ch_mitos_results_pass, CORAL_ANNOTATION_FIX.out.results)
