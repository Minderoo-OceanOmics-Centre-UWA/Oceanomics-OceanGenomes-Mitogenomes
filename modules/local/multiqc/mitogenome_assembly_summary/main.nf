process MITOGENOME_ASSEMBLY_SUMMARY {
    ...
    // Same knob annotation_stats.py gets via ANNOTATION_STATS, so the
    ...
    stub:
    """
    printf "assembly_prefix\\tsample_id\\tassembler\\tstatus\\tfinal_length_bp\\tcircularised\\tnum_candidate_contigs\\tnum_final_contigs\\tnum_genes\\tmissing_genes\\tframeshift_flag\\tmean_coverage\\tcoverage_cv\\treference_species\\treference_accession\\tnumt_flag\\tmanual_review_reason\\n" > mitogenome_assembly_summary_mqc.tsv
